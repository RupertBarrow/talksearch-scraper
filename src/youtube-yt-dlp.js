  ...
  async getVideosFromYtdlpFolder() {
    const config = globals.config() || {
      ...
      channels: [
        ...
        "Canal Crime",
        "Cat M",
        "Célébrités Toute l'actualité",
        "Chaîne officielle TVLibertés",
        "Channel 4 News",
        "Chanteur Célèbre",
        "CityNews",
        "Civicio",
        ...
        "Dav 1er",
        "David Pakman Show",
        "Democracy free opinion worldwide",
        "DocteurBazooka",
        "Elia Iliushina",
        "Emmanuel Verdin",
        "Europe 1",
        ...
        "KILLUMINATY MASTA E.X OFFICIEL",
        "Karl Zéro Absolu",
        "Konbini",
        "La Guillotine",
        "La Vérité Qui Dérange v9 - LVQD",
        "LaurensKids",
        "Laurent Louis",
        "Laurent febvay En tournée",
        "Là-bas si j'y suis",
        "Le Média",
        "Le Monde",
        "Le Précepteur",
        "LeGossipTube",
        "Lebreton LVQD.bak.zip",
        "Les Clochards Célestes",
        ...
        "Omroep PowNed",
        "Onction2vie",
        "Patrick Aliane Hoffman",
        "Pew Tech",
        "Pinoy Learner",
        "Public Enquiry",
        "REALWOMEN_REALSTORIES",
        "RÉFRACTAIRE TV",
        "RTI Officiel",
        "RTL  ",
        "RTS - Radio Télévision Suisse",
        "Radio-Canada Info",
        "Retour à Outreau",
        "Right on Radio CH 2",
        "Riposte Laïque",
        "SLM TV   (le paranormal c'est normal)",
        "Stéphane Edouard",
        "TODAY",
        "The reveal report",
        "TheLipTV",
